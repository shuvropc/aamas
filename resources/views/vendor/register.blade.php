           ...
           {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input required  type="text" name="name" id="fname" pattern="[a-zA-Z ]{2,}"  placeholder="Please enter your full name" required title="It must contain only letters and a length of minimum 2 characters">
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input required type="text" name="phonenumber" id="address" pattern="[a-zA-Z0-9. - , ]{5,}"  placeholder="Please enter contact number" title="It must contain letters and/or separators and a length of minimum 10 characters" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input required type="text" name="vendorname" id="vendorname"   placeholder="Please enter Company Name" title="It must contain letters and/or separators and a length of minimum 10 characters" required>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <label for="address">Company Logo<span>*</span></label>
                    <input required type="file" name="vendorlogo" id="address"   placeholder="Please enter your street address" title="It must contain letters and/or separators and a length of minimum 10 characters" required>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
            ...
            <p class="section"><span class="number">4</span><span class="text">Account credentials</span></p>
            <div class="row">
                <div class="col-sm-12">
