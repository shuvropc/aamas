                                        ...
                                        <table class="table display responsive product-overview mb-30 dataTable no-footer" id="myTable" role="grid" aria-describedby="myTable_info">
                                            ...
                                            @foreach($products as $product)
                                                <tr role="row" class="odd product_row_{{$product->id}}" id="product">
                                                    <td class="txt-dark sorting_1"><a href="{{route('sales.product.details',['id'=>$product->id])}}">{{$product->product_name}}</a></td>
                                                    <td class="txt-dark">{{$product->id}}</td>
                                                    <td>
                                                        <a href="{{route('sales.product.details',['id'=>$product->id])}}"><img src="{{asset($product->image1)}}" width="80"></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="{{route('sales.product.edit',['id'=>$product->id])}}" class="text-inverse pr-10" title="" data-toggle="tooltip" data-original-title="Edit">
                                            ...
                                            <script>
                                                ...
                                                function confirmDelete() {
                                                    ...
                                                    $.ajax({
                                                        type: 'POST',
                                                        url: "http://127.0.0.1:8000/sales/product/delete",
                                                        headers: {
                                                ...
                                                function searchByAnything() {
                                                    ...
                                                    $.ajax({
                                                        type:'GET',
                                                        url:"http://127.0.0.1:8000/employee/search",
                                                        data:{
                                                            value:value
                                                        },
                                                        success: function(result){
