                                        ...
                                        <div id="myTable_wrapper" class="dataTables_wrapper no-footer">
                                            ...
                                            <table class="table display responsive product-overview mb-30 dataTable no-footer" id="myTable" role="grid" aria-describedby="myTable_info">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 91px;" aria-label="Quantity: activate to sort column ascending">Vendor Id</th>
                                                ...
                                                @foreach($products as $product)
                                                    <tr role="row" class="odd product_row_{{$product->id}}" id="product">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#myModal" onclick="deleteFeatured({{$product->id}})" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Delete">
                                                        ...
                                                        <script>
                                                            ...
                                                            function confirmDeleteFeature() {
                                                                ...
                                                                $.ajax({
                                                                    type: 'POST',
                                                                    url: "http://127.0.0.1:8000/admin/featured/delete",
                                                                    headers: {
