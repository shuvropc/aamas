...
<div class="col-md-9">
            ...
            <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="owl-single-product" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 5742px; left: 0px; display: block; transition: all 0ms ease; transform: translate3d(-638px, 0px, 0px);"><div class="owl-item" style="width: 319px;"><div class="single-product-gallery-item" id="slide1">
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p8.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p8.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p9.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p9.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p10.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p10.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p11.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p11.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p12.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p12.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p13.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p13.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p14.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p14.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p15.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p15.jpg')}}">
                                        </a>
                                        ...
                                        <a data-lightbox="image-1" data-title="Gallery" href="assets/images/products/p16.jpg">
                                            <img class="img-responsive" alt="" src="{{asset('assets/images/products/p16.jpg')}}">
                                        </a>
                        ...
                        <div class="owl-controls clickable"><div class="owl-pagination"><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page active"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div></div></div></div><!-- /.single-product-slider -->


                    <div class="single-product-gallery-thumbs gallery-thumbs">

                        <div id="owl-single-product-thumbnails" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                            <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 1440px; left: 0px; display: block; transform: translate3d(0px, 0px, 0px); transition: all 0ms ease;"><div class="owl-item" style="width: 80px;"><div class="item">
    ...
    <section class="section featured-product wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
        ...
        <div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs" style="opacity: 1; display: block;">
            ...
            <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 2484px; left: 0px; display: block; transition: all 0ms ease; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 207px;"><div class="item item-carousel">
                            <div class="products">
